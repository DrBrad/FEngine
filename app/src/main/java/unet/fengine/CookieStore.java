...
public class CookieStore implements java.net.CookieStore {
    ...
    private static final String COOKIE_PREFS = "unet.fengine.cookieprefs";
    private static final String COOKIE_DOMAINS_STORE = "unet.fengine.CookieStore.domain";
    private static final String COOKIE_DOMAIN_PREFIX = "unet.fengine.CookieStore.domain_";
    private static final String COOKIE_NAME_PREFIX = "unet.fengine.CookieStore.cookie_";
